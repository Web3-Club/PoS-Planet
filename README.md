...
3023年 经过200多轮的牛市的洗刷，即使在比特币区块奖励达到了 ***0.0000000000000000......*** 个的前提下 近无限核裂变量子计算集群矿机挖矿热潮仍未停歇 地球被PoW的挖矿潮中被榨干了一切资源 无论是淡水还是任何矿产都被消耗殆尽 

终于 全世界最后的那个**终世区块**挖出 但地球 已达到无法挽回的深渊之中 



本游戏即是在以上的故事背景下展开，一群人类尝试自救,尝试使用PoS的机制,真正**从0开始** 使用 **PoS** 来开垦一个星球。
