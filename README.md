...
> 技术从来都是中性的 <br>
> 无谓善恶，掌握在不同的人手里，才会导致迥异的结局。<sup>[2]</sup>

3023年 

经过200多轮的牛市的洗刷，即使在比特币区块奖励达到了 ***0.0000000000000000......*** 个的前提下 

近无限核裂变量子计算集群矿机挖矿热潮仍未停歇 

地球被PoW的挖矿潮中被榨干了**一切资源** 

无论是淡水还是任何矿产 **都被消耗殆尽**

终于 全世界最后的那个任何人从来都没有意识到的**终世区块** 在3023年10月16日上午4:12分被挖出 

但地球 **已达到无法挽回的深渊之中**

于是,在比特币全部节点失效的大背景下,3023年的以太坊基金会使用以往升级的经验,开启了一轮 **宇宙升级**,

尝试先将所有的DAO 移民到目前已知的唯一宜居行星中去。

这颗星球地质环境极其复杂，受地热分布影响，冰、火等土地属性随机分布，并且互相动态影响。DAO移民携带着地球普通种子，却不清楚该种子难以适应这颗星球复杂的环境，他们即将面临粮食危机！

本游戏即是在以上的故事背景下展开，3023年的尝试自救,尝试使用PoS的机制,真正**从0开始** 使用 **PoS** 来开垦一个星球。
...
#### 土地需要何种属性？
  ...
  **对于上述属性出现的几率待定** 在黑客松期间的代码我们使用的概率是:

                                  10% 极寒土地；10% 冰封种子
                                  10% 极热土地；10% 赤火种子
                                  80% 普通土地；0% 普通种子

  未来我们会使用类似于**有限状态自动机**逻辑的保底抽卡机制背后的概率
...
游戏中的种子、土地以及任何道具都将会NFT化,玩家可以**自由选择**在第三方交易平台 (NFT代销平台、CEX) 或在场外交易

### 成就空投SBT

游戏将会在玩家游玩进度过程中达到的成就 进行SBT
...
一直以来 社会对区块链世界中 我们对于PoW体系下所产生的 **电力能源损失** 以及其衍生的各类问题产生的批判 始终没有暂停过。
...
## 参考文献及资料
 ...
 - [1] [开放世界](https://zh.wikipedia.org/zh-hans/%E9%96%8B%E6%94%BE%E4%B8%96%E7%95%8C)
 - [2] []()
 - [3] []()
 - 
